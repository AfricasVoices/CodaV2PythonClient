...
class CodaV2Client:
    ...
    def update_dataset_user_ids(self, dataset_id, user_ids):
        """
        Updates user ids for the given dataset.
        ...
        :type user_ids: list
        """
        assert isinstance(user_ids, list), "user_ids must be a list"

        if len(user_ids) == 0:
            log.warning(f"No user ids were specified, skipping...")
            return
